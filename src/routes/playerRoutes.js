...
const { createPlayerAdmission, getAllPlayers, searchPlayers, getPlayerById, updatePlayer, deletePlayer, getPlayersAndCoaches, updatePlayerStatus } = require("../controllers/playerController");
